...
class grayscale_ModelTrainingConfig:
    model_path = os.path.join('/config/workspace/CardioVascular_Disease_Prediction/artifacts', 'grayscale_model.h5')


class grayscale_ModelTraining:

    def __init__(self):
        self.model_train_config = grayscale_ModelTrainingConfig()

    
    def grayscale_model_training(self, train_data_set, validation_data_set, test_data_set):

        try: 
            
            logging.info("Initiate grayscale_ Image Model Training.")
            IMAGE_SIZE = [224,224]
            ...
            logging.info("Error occured in grayscale Image Model Training Process.")
